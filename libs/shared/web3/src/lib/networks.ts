import { FantomIcon } from '@fantohm/shared-ui-themes';
import { RinkebyIcon } from '@fantohm/shared-ui-themes';
import { MoonriverIcon } from '@fantohm/shared-ui-themes';
import { MoonbaseAlphaIcon } from '@fantohm/shared-ui-themes';
import { dark as darkTheme } from '@fantohm/shared-ui-themes';
import { river as riverTheme } from '@fantohm/shared-ui-themes';
...
export const networks: INetworks = {
  [NetworkIDs.FantomOpera]: {
    ...
    blockCountdownUrl: (block) =>
      `https://ftmscan.com/block/countdown/${block}`,
  ...
  [NetworkIDs.FantomTestnet]: {
    ...
    epochInterval: 2880,
    blockCountdownUrl: (block) =>
      `https://testnet.ftmscan.com/block/countdown/${block}`,
    ...
    poolGraphUrl:
      'https://api.thegraph.com/subgraphs/name/pooltogether/rinkeby-v3_4_3',
    liquidityPoolReserveDecimals: {
      token0Decimals: 18,
      token1Decimals: 9,
    },
    addresses: {
      ...
      FHUD_ADDRESS: '0xc4175a594dff83FC9034f5b847251ce1e1a786EE',
  ...
  [NetworkIDs.Moonriver]: {
    ...
    addresses: {
      ...
      FHUD_ADDRESS: '0x8617F21f3751994306462e6Dd118a7c02AA133fb',
      XFHM_ADDRESS: "",
    },
  },
  [NetworkIDs.MoonbaseAlpha]: {
    ...
    epochInterval: 1960,
    blockCountdownUrl: (block) =>
      `https://moonbase.moonscan.io/block/countdown/${block}`,
  ...
  [NetworkIDs.Rinkeby]: {
    ...
    epochInterval: 687,
    blockCountdownUrl: (block) =>
      `https://rinkeby.etherscan.io/block/countdown/${block}`,
    ...
    addresses: {
      ...
      FHUD_ADDRESS: '0x1F43eeBFF4af237FD28FDb25eC11f148462DED52',
      XFHM_ADDRESS: "0x9D6A0D99E9d9f6e7f83f7646438c97746a0a14D9",
