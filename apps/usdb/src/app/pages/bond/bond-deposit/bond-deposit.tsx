        ...
        <div id="bond-deposit">
            { typeof(props.bondType) == 'string' ? (
                <Grid container sx={{justifyContent: 'center'}} spacing={3}>
                    <Grid item>
                        <div className={`${rootStyle['flexCenterRow']} ${rootStyle['infoBlock']}`}><Icon component={InfoOutlinedIcon} /> no impermanent loss and no deposit fee</div>
                    </Grid>    
                    <Grid xs={6} item>
                    ...
                    <Grid xs={6} item>
                        <Box className={`${rootStyle['flexCenterCol']} ${style['depositTokenSelectorBox']}`}>
                            <span>DAI balance</span>
                            <span>1000 DAI</span>
                        </Box>
                    </Grid>
                    <Grid xs={6} item>
                        <Box className={`${rootStyle['flexCenterRow']} ${rootStyle['spaceBetween']} ${style['depositAmountBox']}`}>
                    ...
                    <Grid xs={12} item>
                        <Box className={`${rootStyle['flexCenterRow']} ${rootStyle['spaceBetween']}`}>
                            <div className={rootStyle['flexCenterRow']}>Your Deposit <Icon component={InfoOutlinedIcon} /></div>
                            <div>100.00 DAI</div>
                        </Box>
                    </Grid>
                    <Grid xs={12} item>
